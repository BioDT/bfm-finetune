...
from bfm_finetune.aurora_mod import AuroraFlex, AuroraRaw, MaskRatioScheduler
...
def main(cfg):
    ...
    scheduler = MaskRatioScheduler(model.encoder,
                               start_ratio=0.5, final_ratio=0.9,
                               start_epoch=5, total_epochs=cfg.training.epochs)
